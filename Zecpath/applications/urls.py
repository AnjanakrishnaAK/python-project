...
from .views import EmployerMoveStageView,ShortlistCandidateView,RejectCandidateView,CandidateDashboard,CandidateAppliedJobs,ApplyJob,ApplicationTimeline
from .views import  *
urlpatterns = [
